...
abbr -ag gamend  'git commit --amend -m'
...
abbr -ag cat     'bat'
abbr -ag run     'pnpm run'
abbr -ag start   'pnpm start'
abbr -ag build   'pnpm run build'
abbr -ag npmls   'pnpm ls -g --depth=0'
abbr -ag npmo    'pnpm outdated'
abbr -ag untar   'tar -xvf'
abbr -ag tar     'tar -cv'
abbr -ag caff    'caffeinate -d'
abbr -ag d       'du -sh * | sort -hr'
abbr -ag nixn    'rm -rf node_modules; pnpm i; notif done'
abbr -ag co      'code .'
abbr -ag rmr     'rm -rf'
...
abbr -ag npm     'pnpm'
abbr -ag diff    'difft'
abbr -ag npu     'pnpx npm-check -u'
abbr -ag wtp     'git worktree prune'
